...
HttpClient.prototype._setRequestHeader = function(headers, host) {
    var dft = { "Host": host, "Connection": "keep-alive" };
    headers = _.merge(dft, this.headers, headers);
...
HttpClient.prototype.request = function(url, method, headers, content) {
    ...
    headers = that._setRequestHeader(headers, parsed.hostname);
    var opt = {
